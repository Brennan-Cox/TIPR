...
def matching_torch_v1(W, C, delta, device, seed=1):
    ...
    while f > f_threshold:
        ...
        # find push edges
        ind_b_tent_ind, free_S_edge_B_ind_range_lt_inclusive = unique2(ind_S_zero_ind[0], input_sorted=True)
        ...
        ind_a_push, tent_ind = unique2(ind_a_tent, input_sorted=False) #find exact a to push, and corresponding index
